...
class HL7::Message::Segment::TXA < HL7::Message::Segment
  ...
  add_field :primary_activity_provider_code_name, {:format => HL7::Message::DataTypes.XCN}
  add_field :origination_date_time
  add_field :transcription_date_time
  add_field :edit_date_time
  add_field :originator_code_name, {:format => HL7::Message::DataTypes.XCN}
  add_field :assigned_document_authenticator, {:format => HL7::Message::DataTypes.XCN}
  add_field :transcriptionist_code_name, {:format => HL7::Message::DataTypes.XCN}
  ...
  add_field :change_reason
  add_field :authentication_person_time_stamp #, {:format => HL7::Message::DataTypes.PPN}
  add_field :distributed_copies, {:format => HL7::Message::DataTypes.XCN}
end
